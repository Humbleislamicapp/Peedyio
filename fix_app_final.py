        ...
        <div className="flex-1 overflow-y-auto flex flex-col">
          ...
          {activeView === 'create' && (
            <div className="flex-1 flex flex-col items-center justify-center text-center p-8">
              ...
              <h1 className="text-2xl font-bold text-slate-900">Create PDF</h1>
              <p className="text-slate-500 mt-2 max-w-md">
                Create blank documents or generate PDFs from templates and images.
              </p>
              <div className="flex gap-4 mt-6">
                <button onClick={handleCreateBlankDocument} className="px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-lg shadow-sm transition-colors">
                  Create Blank
                </button>
                <button onClick={() => setActiveView('templates')} className="px-4 py-2 bg-slate-100 hover:bg-slate-200 text-slate-700 font-semibold rounded-lg transition-colors">
                  Browse Templates
                </button>
              </div>
            </div>
